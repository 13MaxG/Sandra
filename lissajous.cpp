...
//        for(std::list<std::string>::iterator iter = ArgDbKeyNames.begin(); iter  != ArgDbKeyNames.end(); ++iter)
//        {
...
//                    ArgDbKey[(*iter)].Set(Key<double>(fromString< double > (command[0]), fromString< double > (command[1])));
...
//    ArgDbKey["test"].Prepare();
//    std::cout<<ArgDbKey["test"].GetAbsolute(0.5)<<"##"<<std::endl;
//}
